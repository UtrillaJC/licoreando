...
class SearchForm(forms.Form):
    ...
    precioMinimo = forms.FloatField(required=False,label="Precio mínima",min_value=0,max_value=9999)
    precioMaximo = forms.FloatField(required=False,label="Precio máxima",min_value=0,max_value=9999)
